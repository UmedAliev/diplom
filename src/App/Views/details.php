            ...
            <div class="row">
                ...
                <div class="col-12 col-xl-6">
                    <video controls crossorigin playsinline
                        ...
                        <!-- Video files -->
                        <source src="http://diplom/<?php echo $movie->media_path ?>" type="video/mp4" size="576">
                    ...
                    <div class="details__wrap">
                        ...
                        <div class="details__devices">
                            ...
                            <ul class="details__devices-list">
                                ...
                                <a href= "<?php echo isset($_SESSION['user_id']) ? $movie->media_path : 'signin'; ?>" >
                                    <li><i class="icon ion-ios-download"></i><span>Download</span></li>
                                </a>
                                =====================================================================
                            ...
                            <div class="content__mobile-tabs-menu dropdown-menu" aria-labelledby="mobile-tabs">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li class="nav-item"><a class="nav-link" id="2-tab" data-toggle="tab" href="#tab-2"
                                                            role="tab" aria-controls="tab-2" aria-selected="false">Reviews</a>
                                    </li>

                                    <li class="nav-item"><a class="nav-link" id="3-tab" data-toggle="tab" href="#tab-3"
                                                            role="tab" aria-controls="tab-3" aria-selected="false">Photos</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                        ...
                                        <ul class="comments__list">
                                            <li class="comments__item">
                                                <div class="comments__autor">
                                                    <img class="comments__avatar" src="../Resources/img/user.png"
                                                         alt="">
                                        ...
                                        <ul class="reviews__list">
                                            <li class="reviews__item">
                                                <div class="reviews__autor">
                                                    <img class="reviews__avatar" src="../Resources/img/user.png" alt="">
                            ...
                            <div class="gallery" itemscope>
                                <div class="row">
                                    ...
                                    <figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
                                        <a href="../Resources/img/gallery/project-1.jpg" itemprop="contentUrl"
                                           data-size="1920x1280">
                                            <img src="../Resources/img/gallery/project-1.jpg" itemprop="thumbnail"
                                    ...
                                    <!-- gallery item -->
                                    <figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
                                        <a href="../Resources/img/gallery/project-2.jpg" itemprop="contentUrl"
                                           data-size="1920x1280">
                                            <img src="../Resources/img/gallery/project-2.jpg" itemprop="thumbnail"
                                                 alt="Image description"/>
                                        </a>
                                    ...
                                    <!-- gallery item -->
                                    <figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
                                        <a href="../Resources/img/gallery/project-3.jpg" itemprop="contentUrl"
                                           data-size="1920x1280">
                                            <img src="../Resources/img/gallery/project-3.jpg" itemprop="thumbnail"
                                                 alt="Image description"/>
                                        </a>
                                    ...
                                    <!-- gallery item -->
                                    <figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
                                        <a href="../Resources/img/gallery/project-4.jpg" itemprop="contentUrl"
                                           data-size="1920x1280">
                                            <img src="../Resources/img/gallery/project-4.jpg" itemprop="thumbnail"
                                                 alt="Image description"/>
                                        </a>
                                    ...
                                    <!-- gallery item -->
                                    <figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
                                        <a href="../Resources/img/gallery/project-5.jpg" itemprop="contentUrl"
                                           data-size="1920x1280">
                                            <img src="../Resources/img/gallery/project-5.jpg" itemprop="thumbnail"
                                                 alt="Image description"/>
                                        </a>
                                    ...
                                    <!-- gallery item -->
                                    <figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
                                        <a href="../Resources/img/gallery/project-6.jpg" itemprop="contentUrl"
                                           data-size="1920x1280">
                                            <img src="../Resources/img/gallery/project-6.jpg" itemprop="thumbnail"
                                                 alt="Image description"/>
                                        </a>
                ...
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="row">
                        ...
                        <div class="col-6 col-sm-4 col-lg-6">
                            <div class="card">
                                <div class="card__cover">
                                    <img src="../Resources/img/covers/cover.jpg" alt="">
                        ...
                        <div class="col-6 col-sm-4 col-lg-6">
                            <div class="card">
                                <div class="card__cover">
                                    <img src="../Resources/img/covers/cover2.jpg" alt="">
                                    <a href="#" class="card__play">
                                        <i class="icon ion-ios-play"></i>
                                    </a>
                                </div>
                        ...
                        <div class="col-6 col-sm-4 col-lg-6">
                            <div class="card">
                                <div class="card__cover">
                                    <img src="../Resources/img/covers/cover3.jpg" alt="">
                                    <a href="#" class="card__play">
                                        <i class="icon ion-ios-play"></i>
                                    </a>
                                </div>
                        ...
                        <div class="col-6 col-sm-4 col-lg-6">
                            <div class="card">
                                <div class="card__cover">
                                    <img src="../Resources/img/covers/cover4.jpg" alt="">
                                    <a href="#" class="card__play">
                                        <i class="icon ion-ios-play"></i>
                                    </a>
                                </div>
                        ...
                        <div class="col-6 col-sm-4 col-lg-6">
                            <div class="card">
                                <div class="card__cover">
                                    <img src="../Resources/img/covers/cover5.jpg" alt="">
                                    <a href="#" class="card__play">
                                        <i class="icon ion-ios-play"></i>
                                    </a>
                                </div>
                        ...
                        <div class="col-6 col-sm-4 col-lg-6">
                            <div class="card">
                                <div class="card__cover">
                                    <img src="../Resources/img/covers/cover6.jpg" alt="">
                                    <a href="#" class="card__play">
                                        <i class="icon ion-ios-play"></i>
                                    </a>
                                </div>
