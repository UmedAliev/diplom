            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="faq">
                        ...
                        <p class="faq__text">Various versions have evolved over the years, sometimes by accident,
                            sometimes on purpose (injected humour and the like).</p>
                    </div>

                    <div class="faq">
                        <h3 class="faq__title">Why isn't there a HD version of this video?</h3>
                        <p class="faq__text">Many desktop publishing packages and web page editors now use Lorem Ipsum
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="faq">
                        ...
                        <p class="faq__text">It was popularised in the 1960s with the release of Letraset sheets
