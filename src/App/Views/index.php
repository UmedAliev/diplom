...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" type="text/css" href="src/App/Views/css/bootstrap-reboot.min.css">
    <link rel="stylesheet" type="text/css" href="src/App/Views/css/bootstrap-grid.min.css">
    <link rel="stylesheet" type="text/css" href="src/App/Views/css/owl.carousel.min.css">
    <link rel="stylesheet" type="text/css" href="src/App/Views/css/jquery.mCustomScrollbar.min.css">
    <link rel="stylesheet" type="text/css" href="src/App/Views/css/nouislider.min.css">
    <link rel="stylesheet" type="text/css" href="src/App/Views/css/ionicons.min.css">
    <link rel="stylesheet" type="text/css" href="src/App/Views/css/plyr.css">
    <link rel="stylesheet" type="text/css" href="src/App/Views/css/photoswipe.css">
    <link rel="stylesheet" type="text/css" href="src/App/Views/css/default-skin.css">
    <link rel="stylesheet" type="text/css" href="src/App/Views/css/main.css">
                        ...
                        <ul class="header__nav">
                            ...
                            <li class="header__nav-item">
                                ...
                                <ul class="dropdown-menu header__dropdown-menu" aria-labelledby="dropdownMenuHome">
                                    <li><a href="/index">Home slideshow bg</a></li>
                                    <li><a href="/index2">Home static bg</a></li>
                                </ul>
                            </li>
                            <!-- end dropdown -->
